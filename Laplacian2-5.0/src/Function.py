...
def image_print(height,width,num):
    ...
    string2 = 'x'
    string3 = ' -g ../imgs/img_out_gray.gray -i ../imgs/img_out_h.gray ../imgs/img_out_v.gray -x ../src/config.txt 17'
...
def writefile():
    ...
    r4 = random.choice([1, 5])
    r5 = random.choice([3, 7])
    #rd = random.randint(0,8)
    #rp = random.randint(0,8)
    #rs = random.randint(0,8)
    #omega[rd] = random.choice(mult)
    #omega[rp] = random.choice(mult)
    #omega[rs] = random.choice(mult)
    omega[0] = 0.024
    omega[1] = random.choice(mult4)
    omega[2] = 0.024
    omega[3] = random.choice(mult)
    omega[4] = random.choice(mult2)
    omega[5] = random.choice(mult3)
    omega[6] = 0.024
    omega[7] = random.choice(mult3)
    omega[8] = 0.024

    adder2 = [0.0,0.004]
    adder3 = [0.0,0.004, 0.056]
    for j in range(8):
        omega.append(random.choice(adder3))

    #r1 = random.choice([12, 13, 14])
    #r2 = random.choice([12, 13, 14])
