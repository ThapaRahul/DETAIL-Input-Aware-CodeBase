...
path = '/home/rahul/SobelFilter-master2-5.0/imgs_data/cat_images/50_cats/'

#path = '/home/rahul/SobelFilter-master2/imgs_data/cat_images/50_cats/'
#path = '/home/rahul/SobelFilter-master2/imgs_data/dog_images/50_dogs/'
...
if rd < 90 :
    ...
    children = Function.four_points_crossover(ten_units)
if rd >= 90:
    #children = Function.two_points_mutation(ten_units)
    #children = Function.three_points_mutation(ten_units)
    children = Function.four_points_mutation(ten_units)
