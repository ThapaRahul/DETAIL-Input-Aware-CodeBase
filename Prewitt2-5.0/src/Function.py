...
def writefile():
    ...
    #rd = random.randint(0,17)
    #rp = random.randint(0,17)
    #omega[rd] = random.choice(mult)
    #omega[rp] = random.choice(mult)
    omega[1] = 0.024
    omega[3] = random.choice(mult4)
    omega[4] = 0.024
    omega[6] = random.choice(mult4)
    omega[7] = 0.024
    omega[12] = 0.024
    omega[13] = 0.024
    omega[14] = 0.024
    omega[15] = random.choice(mult4)
    omega[16] = random.choice(mult4)
    omega[17] = random.choice(mult4)
    
    #omega[15] = random.choice([0.0,0.00072,0.0024, 0.008])
    #omega[16] = random.choice([0.0,0.00072,0.0024, 0.008])
    #omega[17] = random.choice([0.0,0.00072,0.0024, 0.008])

    adder = [0.0,0.004]
    for j in range(17):
        omega.append(random.choice(adder))

    """
    omega[18] = random.choice(adder)
    omega[19] = random.choice(adder)
    omega[22] = random.choice(adder)
    omega[24] = random.choice(adder)
    omega[26] = random.choice(adder)
    omega[31] = random.choice(adder)
    omega[32] = random.choice(adder)
